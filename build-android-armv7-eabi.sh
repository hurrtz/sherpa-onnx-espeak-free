...
if [ -z $SHERPA_ONNX_ENABLE_ESPEAK ]; then
  SHERPA_ONNX_ENABLE_ESPEAK=ON
fi
...
cmake -DCMAKE_TOOLCHAIN_FILE="$ANDROID_NDK/build/cmake/android.toolchain.cmake" \
    ...
    -DSHERPA_ONNX_ENABLE_ESPEAK=$SHERPA_ONNX_ENABLE_ESPEAK \
    -DSHERPA_ONNX_LIBPHONEMIZE_ROOT=${SHERPA_ONNX_LIBPHONEMIZE_ROOT:-} \
